          ...
          <div class="footer-widget">
            ...
            <div class="row" style="margin-top:20px">
              <div class="col-md-12">
                ...
                <a href="mailto:officialelengsolo@gmail.com" style="color: white">officialelengsolo@gmail.com</a>
              </div>
            </div>
            <div class="row" style="margin-top:20px">
              <div class="col-md-12">
                <span style="font-size: 25px;color: white;">Call Center</span><br>
              <a href="whatsapp://send?text=Halo&phone=+6285848402242" style="color: white;">+62 858-4840-2242</a>
              </div>
            </div>
          </div>
        </div>
