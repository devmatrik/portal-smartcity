    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-6">
          <div class="add-box">
              ...
              <ul>
                <li><i class="fas fa-phone"></i> <strong>Telepon:</strong>  <a href="whatsapp://send?text=Halo&phone=+6285848402242">+62 858-4840-2242</a></li>
                <li><i class="fas fa-building"></i> <strong>Alamat:</strong> <br>
                    TMC Surakarta
                </li>
                <li><i class="far fa-envelope"></i><strong> Email:</strong> officialelengsolo@gmail.com</li>
              </ul>
          </div>
        </div>
